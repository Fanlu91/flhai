...
draft: false
summary: This article demonstrates how to create and use a donut chart component based on Chart.js within MDX posts. It shows the integration of custom React components to enhance interactivity and visual appeal in the content.
---
